...
/**
 * Created by Snow Volf on 15.07.2017, 20:04
 */

public class CerificateUtils {
    private static final int MAGIC = -1395514454;
    public static final String FILE_NAME = "FileName";
    public static final String KEYSTORE_PASSWORD = "KeystorePassword";
    public static final String ALIAS_NAME = "AliasName";
    public static final String ALIAS_PASSWORD = "AliasPassword";
...
//    }
    ...
    public static void readIni(final HashMap<String, String> map, final File ini) throws IOException {
    ...
    public static KeyStore loadKeyStore(final File file, final String passWord) throws Exception {
        final KeyStore keyStore = KeyStore.getInstance("jks");
        keyStore.load(new FileInputStream(file), passWord.toCharArray());
        return keyStore;
    }

    public static void split(final KeyStore keyStore, final String name, final File dir, final String alias, final String passWord) throws Exception {
    ...
    public static void encryptSplit(final KeyStore keyStore, final File outFile, final String filePassWord, final String alias, final String passWord) throws Exception {
        final Certificate pubkey = keyStore.getCertificate(alias);
        final Key key = keyStore.getKey(alias, passWord.toCharArray());
        final KeyPair kp = new KeyPair(pubkey.getPublicKey(), (PrivateKey)key);
